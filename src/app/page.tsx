...
import {
  ...
  Settings, Menu, Copy, MousePointer2, Shapes, Hand, Radio
} from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            <Link href="/radio">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#FF1744] to-[#ec4899] hover:from-[#ec4899] hover:to-[#FF1744] rounded-lg transition-all duration-300 shadow-[0_0_15px_rgba(255,23,68,0.3)] hover:shadow-[0_0_25px_rgba(255,23,68,0.5)]"
                title="Radio Player"
              >
                <Radio className="w-5 h-5 text-white" />
                <span className="text-white font-bold text-sm">Radio</span>
              </motion.button>
            </Link>
